...
const MessageItem = forwardRef<HTMLDivElement, Props>(({ message, isNextMessageSamePerson }, ref) => {
    return (
        <div ref={ref} className={cn('flex items-end', {
            ...
            <div className={cn('relative flex h-6 w-6 aspect-square items-center justify-center', {
                ...
                'order-1 bg-zinc-100 rounded-sm': !message.isUserMessage,
            ...
            <div className={cn('flex flex-col spacce-y-2 text-base max-w-md mx-2', {
