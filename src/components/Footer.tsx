            ...
            <MaxWidthWrapper>
                <div className="flex lg:h-20 items-center justify-between">
                    ...
                    <div className="items-center space-x-4 sm:flex">
                        <span>Feito por <a className='font-semibold text-green-600 hover:text-green-700' href='https://www.linkedin.com/in/eduardo-danttas/' target='_blank'>Eduardo Dantas</a></span>
                    </div>
                </div>
            </MaxWidthWrapper>
        </footer>
